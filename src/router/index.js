...
export const asyncRoutes = [
  {
    ...
    children: [
      {
        path: 'create',
        component: () => import('@/views/exhibition/create'),
        name: 'CreateExhibition',
        meta: { title: 'Create Exhibition', icon: 'edit' }
      },
      {
        path: 'edit/:id(\\d+)',
        component: () => import('@/views/exhibition/edit'),
        name: 'EditExhibition',
        meta: { title: 'Edit Exhibition', noCache: true, activeMenu: '/example/list' },
        hidden: true
      },
      {
        path: 'list',
        ...
        name: 'ExhibitionList',
        meta: { title: 'Exhibition List', icon: 'list' }
      }
    ]
  },
  {
...

  {
    ...
    children: [
      {
        path: 'https://arts.nthu.edu.tw/#/',
        meta: { title: '藝術中心官網', icon: 'link' }
      }
    ]
  },
